...
def _env_flag(n, d=False):
    return str(os.getenv(n, str(int(d)))).lower() in ("1", "true", "yes", "y", "on")
...
def latch_dets(
    dets_now: list[tuple[str, float, tuple[int, int, int, int]]],
