...
from .face_emotions import EXPR_MAP, ExprAdjust
...
class FaceFrame:
    ...
    brow_l: Arc
    brow_r: Arc
    mouth_arc: Arc | None = None
    mouth_rect: Rect | None = None
...
def compute_frame(
    ...
    state_brow = {"idle": +0.06, "wake": +0.10, "record": +0.08, "process": +0.04, "low_battery": +0.18}.get(
        state, +0.06
    )
