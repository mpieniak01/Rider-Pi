...
> Zobacz [../scripts/README.md](scripts/README.md) i [archive/_pr_summaries/SCRIPTS_MIGRATION_SUMMARY.md](archive/_pr_summaries/SCRIPTS_MIGRATION_SUMMARY.md)
...
- ✅ `config/POLICY.md` — polityka konfiguracji i sekretów
