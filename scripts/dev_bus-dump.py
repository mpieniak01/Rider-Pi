...
Domyślnie:
  ...
  TOPIC = motion
Użycie:
  python3 scripts/dev_bus-dump.py                 # dump 'motion'
  TOPIC="*" python3 scripts/dev_bus-dump.py       # dump wszystkie
  TOPIC="vision" python3 scripts/dev_bus-dump.py  # dump 'vision'
"""
