...
def main():
	...
	parser.add_argument("--force", choices=["raw:rgb565","push_frame:rgb565_3","png"], default="raw:rgb565", help="Tryb wypychania klatki")
	...
	spi_hz = parse_env_or_arg(args.spi_hz, "FACE_LCD_SPI_HZ", None, int)
